...
class MainService:
    ...
    fecha_activacion_bono1 = datetime(year=2022, month=12, day=9, hour=14, minute=12, second=9)
    ...
    ab2 = Abonado(nombre='Eladio', apellidos='Carrion', gmail='hugoboss@gmail.com', dni='87654321Z',
